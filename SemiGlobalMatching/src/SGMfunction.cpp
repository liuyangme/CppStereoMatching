...
{
	cvtColor(leftImage, leftImage, COLOR_BGR2RGB);
	cvtColor(rightImage, rightImage, COLOR_BGR2RGB);
	...
	cvtColor(tmp, lGray, COLOR_RGB2GRAY);
	lGray.convertTo(lGray, CV_8U, 255);

	rightImage.convertTo(tmp, CV_32F);
	cvtColor(tmp, rGray, COLOR_RGB2GRAY);
