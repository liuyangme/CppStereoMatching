...
int main() {
	...
	//export result
	imwrite("image/disp_img/000048_10_res_64d.png", postlDis); 
	imwrite("image/disp_img/000048_10_leftrow_64d.png", left_row_disp);
	imwrite("image/disp_img/000048_10_rightrow_64d.png", right_row_disp);
	std::cout << "Image Write Done!\n" << std::endl;

	//evaluate
	Mat MyDisp = imread("image/disp_img/000048_10_res_64d.png", 0);
	...
	Mat lRow = imread("image/disp_img/000048_10_leftrow_64d.png", 1);
	Mat RRow = imread("image/disp_img/000048_10_rightrow_64d.png", 1);
